...
### Important Update (2023/11/13)
We have released the [code](https://github.com/XieResearchGroup/Physics-aware-Multiplex-GNN) for **PAMNet**, which is an improved version of MXMNet with **higher accuracy and efficiency**:
